                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h4 class="fw-bolder">${list.productName}</h4>
                                    <!-- Product reviews-->
                                    ...
                                    <!-- Product price-->
                                    <fmt:formatNumber value="${list.productPrice}" pattern="###,###,###"></fmt:formatNumber>원
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/product/view?n=${list.productCode}">상세보기</a></div>
                            </div>
                        </div>
                    </div>
                </c:forEach>
