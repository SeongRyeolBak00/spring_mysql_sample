...
<div class="wrapper">
    <div class="container">
        ...
        <form id="join_form" class="join-form" name="form1" method="post">
		<div class="wrap">
			<div class="subjecet">
				<span>회원가입</span>
			</div>
			...
			<div class="pw_wrap">
				...
				<div class="pw_input_box">
					<input class="pw_input" name="userPw" type="password">
			...
			<div class="mail_wrap">
				...
				<div class="mail_check_wrap">
					<div class="mail_check_input_box" id="mail_check_input_box_false">
						...
						<span class="final_mail_check_ck">이메일을 인증해주세요.</span>
					</div>
...
$(document).ready(function(){
	...
	$(".join_button").click(function(){
        ...
        /* 최종 유효성 검사 */
        if(idCheck&&idckCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&mailCheck&&mailnumCheck&&phoneCheck&&addressCheck ){
